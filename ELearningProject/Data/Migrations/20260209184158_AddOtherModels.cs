        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tracks_Batches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lectures_Tracks_TrackId",
                        column: x => x.TrackId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Progress_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BatchStudents_StudentId_BatchId",
                table: "BatchStudents",
                columns: new[] { "StudentId", "BatchId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Lectures_TrackId",
                table: "Lectures",
                column: "TrackId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Progress_StudentId_TrackId",
                table: "Progress",
                columns: new[] { "StudentId", "TrackId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Progress_TrackId",
                table: "Progress",
                column: "TrackId");
